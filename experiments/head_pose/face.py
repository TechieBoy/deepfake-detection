...
face_shape_predictor = dlib.shape_predictor("dlib-models/shape_predictor_5_face_landmarks.dat")

face_descriptor = dlib.face_recognition_model_v1("dlib-models/dlib_face_recognition_resnet_model_v1.dat")

pose_predictor_68_point = dlib.shape_predictor("dlib-models/shape_predictor_68_face_landmarks.dat")
